...
# logger = setup_logger('test_result', args.result_dir, if_train=True)
...
def pratice_evaluate(result_dir, dataset, logger):
    ...
    # logger.info(args.dataset+' Rank@1:%f Rank@5:%f Rank@10:%f mAP:%f'%(CMC[0], CMC[4], CMC[9], ap/len(query_label)))
    # logger.info('-'*15)
    # print()
    # # print(args.dataset+' Rank@1:%f Rank@5:%f Rank@10:%f mAP:%f'%(CMC[0], CMC[4], CMC[9], ap/len(query_label)))
    # # print('-'*15)
