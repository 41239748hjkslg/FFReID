...
parser.add_argument('--datasets',default='MSMT17,cuhk01,viper,prid,3dpes,ilids,market,cuhk03-np,duke',type=str, help='datasets used')
...
parser.add_argument('--local_model_reg', default=False, type=bool, help='local model regularity')
parser.add_argument('--feat_reg', default=False, type=bool, help='local model regularity')
parser.add_argument('--test_dataset', default='duke', type=str, help='test dataset')
